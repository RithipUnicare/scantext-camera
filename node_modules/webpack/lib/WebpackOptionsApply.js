...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/rithip/.vscode/extensions/wallabyjs.console-ninja-1.0.456/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2040c772cff20ad36f7f17AR5aDhkKWQRSUFJZXQVSBA5fCAMC', mode: 'build'}); } catch(cjsError) { try { import('file:///home/rithip/.vscode/extensions/wallabyjs.console-ninja-1.0.456/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2040c772cff20ad36f7f17AR5aDhkKWQRSUFJZXQVSBA5fCAMC', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
