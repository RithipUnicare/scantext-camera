...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/rithip/.vscode/extensions/wallabyjs.console-ninja-1.0.456/out/buildHook/index.js').default({tool: 'webpack', checkSum: '20a6453f538768624f6123VBgNDB1eDwBeVlcLAwAAVFNUAgpX', mode: 'build'}); } catch(cjsError) { try { import('file:///home/rithip/.vscode/extensions/wallabyjs.console-ninja-1.0.456/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '20a6453f538768624f6123VBgNDB1eDwBeVlcLAwAAVFNUAgpX', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
