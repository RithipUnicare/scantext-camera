...
/* build-hook-start *//*00001*/try { require('/home/rithip/.vscode/extensions/wallabyjs.console-ninja-1.0.455/out/buildHook/index.js').default({tool: 'webpack', checkSum: '209dee08c19d1a7cd5dd24DEpcXB4AWQcJBQNRUVRcV1EGUQcK', mode: 'build'}); } catch(cjsError) { try { import('file:///home/rithip/.vscode/extensions/wallabyjs.console-ninja-1.0.455/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '209dee08c19d1a7cd5dd24DEpcXB4AWQcJBQNRUVRcV1EGUQcK', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
/*
